...
- [Video Game & Soundtrack Music](#video-game--soundtrack-music-vgmost)
- [Podcasts](#podcasts)
...
**VGM download tip:** Search YouTube for `"game name" OST full` then use `yt-dlp -x --audio-format mp3` to extract. Many complete OSTs are uploaded as single videos or playlists.
